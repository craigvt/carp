...
void entity_init_play(void)
{
        ...
        for (int i = 0; i < MAX_FISH; i++) {
                ...
                entity.fish_arr[i].id = fish_count;
                fish_count++;
        }
...
{
        render_draw(entity.texture, &entity.turtle.src, &entity.turtle.dst);

        for (int i = 0; i < MAX_FISH; i++) {
                if (entity.fish_arr[i].active) {
                        render_draw(entity.texture, &entity.fish_arr[i].src, &entity.fish_arr[i].dst);
                }
        }
}
...
void entity_spawn_turtle(void)
{
        ...
        if (entity.turtle_active == false) {
                ...
                if (entity.turtle.direction == 1) {
                        ...
                        entity.turtle.dst    = (SDL_Rect){render_get_x() - (TURTLE_W * scale), spawn_y, TURTLE_W * scale, TURTLE_H * scale};
                }
                if (entity.turtle.direction == 2) {
                        entity.turtle.src    = (SDL_Rect){0, 272, TURTLE_W, TURTLE_H};
                        entity.turtle.dst    = (SDL_Rect){render_get_w(), spawn_y, TURTLE_W * scale, TURTLE_H * scale};
                }
...
void entity_update_turtle(void)
{
        if (entity.turtle_active) {
                ...
                if (entity.turtle.direction == 1) {
                        ...
                        if (entity.turtle.dst.x > render_get_w()) {
                                entity.turtle_active = false;  
                        }     
                }
                ...
                if (entity.turtle.direction == 2) {
                        entity.turtle.dst.x = entity.turtle.dst.x - entity.turtle.speed;
                        if (entity.turtle.dst.x < render_get_x() - (TURTLE_W * render_get_scale()) ) {
                                entity.turtle_active = false;  
                        }     
                }
        ...
        if (entity.fish_active < entity.fish_cap && entity.fish_spawn_timer > entity.fish_spawn_rate) {
                ...
                case 1:
                        if (entity.fish_arr[open_slot].direction == 1) {
                                ...
                                entity.fish_arr[open_slot].dst = (SDL_Rect){render_get_x() - (BIGFISH_W * scale), spawn_y, BIGFISH_W * scale, FISH_H * scale};
                        } 
                        if (entity.fish_arr[open_slot].direction == 2) {
                                entity.fish_arr[open_slot].src = (SDL_Rect){0, 16, BIGFISH_W, FISH_H};
                                entity.fish_arr[open_slot].dst = (SDL_Rect){render_get_w(), spawn_y, BIGFISH_W * scale, FISH_H * scale};
                        }
                        break;
                case 2:
                        if (entity.fish_arr[open_slot].direction == 1) {
                ...
                case 5:
                        if (entity.fish_arr[open_slot].direction == 1) {
                                ...
                                entity.fish_arr[open_slot].dst = (SDL_Rect){render_get_x() - (SMOLFISH_W * scale), spawn_y, SMOLFISH_W * scale, FISH_H * scale};
                        } 
                        if (entity.fish_arr[open_slot].direction == 2) {
                                entity.fish_arr[open_slot].src = (SDL_Rect){0, 144, SMOLFISH_W, FISH_H};
                                entity.fish_arr[open_slot].dst = (SDL_Rect){render_get_w(), spawn_y, SMOLFISH_W * scale, FISH_H * scale};
                        }
                        break;
                case 6:
                        if (entity.fish_arr[open_slot].direction == 1) {
        ...
        for (int i = 0; i < MAX_FISH; i++) {
                ...
                if (entity.fish_arr[i].active == true) {
                        ...
                        if (entity.fish_arr[i].direction == 1) {
                                ...
                                if (entity.fish_arr[i].dst.x > render_get_w()) {
                                        entity.fish_arr[i].active = false;
                                        entity.lanes[active_lane].active = false;
                                        entity.fish_active--;   
                                }     
                        ...
                        if (entity.fish_arr[i].direction == 2) {     
                                ...
                                if (entity.fish_arr[i].dst.x < render_get_x() - (entity.fish_arr[i].src.w * scale) ) {
                                        entity.fish_arr[i].active = false;
                                        entity.lanes[active_lane].active = false;
                                        entity.fish_active--;
                                }
